...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                { new Integer(1), "Tailor", "In Use",  new Integer(101),  new Float(4.0),  new Float(470.0)},
                { new Integer(2), "Alice", "In Use",  new Integer(203),  new Float(3.0),  new Float(390.0)},
                { new Integer(3), "Jonny", "In Use",  new Integer(105),  new Float(2.0),  new Float(560.0)},
                { new Integer(4), "Jannet", "In Use",  new Integer(103),  new Float(6.0),  new Float(100.0)},
                { new Integer(5), "Robert", "In Use",  new Integer(106),  new Float(3.0),  new Float(400.0)}
            },
            new String [] {
                "Serial Number", "Username", "Status", "PC Number", "Hours Left", "Total"
            }
        ) {
        ...
        jTabbedPane5.addTab("Admin Dashboard", jPanel2);
        ...
        jTabbedPane5.addTab("Home", jPanel4);
